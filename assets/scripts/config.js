  ...
  locales: {
    ja: {
      ...
      copy: {
        ...
        photoDotsAria: "写真の位置",
        photoCarouselRoleDescription: "カルーセル",
        photoSlideRoleDescription: "スライド",
        photoAutoplayAria: "写真の自動再生",
        photoAltPrefix: "ウェディング写真",
        photoDotPrefix: "写真",
        photoGalleryCta: "すべての写真を見る",
        photoGalleryCtaNote: "全17枚のフォトギャラリーへ",
        photoLightboxAria: "写真の拡大表示",
        photoCloseAria: "拡大表示を閉じる",
        photoPreviousAria: "前の写真を表示",
        photoNextAria: "次の写真を表示",
    ...
    en: {
      ...
      copy: {
        ...
        photoCarouselRoleDescription: "carousel",
        photoSlideRoleDescription: "slide",
        photoAutoplayAria: "Photo autoplay",
        photoAltPrefix: "Wedding photo",
        photoDotPrefix: "Photo",
        photoGalleryCta: "View all photos",
        photoGalleryCtaNote: "Open the complete 17-photo gallery",
        photoLightboxAria: "Enlarged photo view",
        photoCloseAria: "Close enlarged photo",
        photoPreviousAria: "Show previous photo",
        photoNextAria: "Show next photo",
